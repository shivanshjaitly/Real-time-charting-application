...
class Settings(BaseSettings):
    ...
    # 1m bars of history at startup (525600 ≈ 365 days). Higher intervals derived from these.
    # Hybrid hourly seed keeps startup fast; increase via CHART_SEED_1M_BARS for more depth.
    seed_1m_bars: int = 525_600
